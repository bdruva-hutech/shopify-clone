...
// document.addEventListener("DOMContentLoaded", function () {
//   const wishlistButtons = document.querySelectorAll(".wt-button");
//   const removeButtons = document.querySelectorAll(".remove-wt-btn");
//   const wishlistCountEl = document.getElementById("wt-count");
//   let wishlist = JSON.parse(localStorage.getItem("wishlist")) || [];
...
//       // remove "active" from this button
//       this.classList.remove("active");

//       // also remove active from any matching "Add" button
//       const addBtn = document.querySelector(`.wt-button.add-wishlist[data-product-handle="${handle}"]`);
...
>>>>>>> 1f9c40f79b5b876ec3b5e3ce9f67c8da9f1efbc5
